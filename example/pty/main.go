...
func main() {
	...
	process1 := consolestream.NewPTYProcess("echo", cancellor, "-e", "\\033[31mRed text\\033[0m and \\033[32mGreen text\\033[0m")
	...
	process2 := consolestream.NewPTYProcessWithSize("bash", cancellor, size, "-c", "echo 'Terminal size: '$(tput cols)'x'$(tput lines)")
	...
	process3 := consolestream.NewPTYProcess("bash", cancellor, "-c", `
