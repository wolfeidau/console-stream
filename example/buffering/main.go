...
func main() {
	...
	process1 := consolestream.NewProcess("echo", []string{"Fast feedback example"},
	...
	process2 := consolestream.NewProcess("echo", []string{"Large buffer example"},
	...
	process3 := consolestream.NewProcess("echo", []string{"Custom configuration example"},
